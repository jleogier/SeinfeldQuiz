    ...
    /******** Displays the Quiz question, progression, and score  ******/           
        ...
        <section class="Quiz">        
            <h3 id='questionDisplay'>${qnASet.question}</h3>        
                <h4 id="trackerDisp">Quiz question tracker:<br>${questionNum} / 5</h4>
                    <form>
                        <fieldset>
                            ${answersDisplay()}
                        </fieldset>
    ...
    function evalQnA (userAns){
        ...
        if (userAns === quizApp[questionIndex].correctAns()){
            ...
            let wrongMessage = `
                                <section class="Quiz">
                                    <h4 id="scoreDisplay">Your Score:<br> ${score} / 5</h4>
                                    <iframe src="https://giphy.com/embed/W86SkcDSRlnwY" width="244" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
                                </section> 
                                <button id="nextQ">Next Question</button>                       
                                `
    ...
    $('body').on('click','#nextQ',function(e){
        ...
        function nextQuestion (score){      
            ...
            if (questionNum === 6){
                ...
                let output = [$('.Quiz').html(quizDisplay(questionNum, score)), console.log('The score is: '+ score)];
            ...
            let beatQuizMessage =                                         
                                `<section class="Quiz">
                                        ...
                                        <h1 id="beatQuiz">Congratulations! You know your Seinfeld!</h1>
                                            <a href="http://reactiongifs.com/?p=13217"><img src="http://www.reactiongifs.com/r/2013/07/happy-dance-.gif"></a>
            ...
            let lostQuizMessage = 
                                ` <section class="Quiz">
                                    ...
                                    <h1 id="beatQuiz">You didn't pass. Try again!</h1>
                                        <iframe src="https://giphy.com/embed/PEtL0mS2JXMBi" width="480" height="360" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
                                    <button id="restartButton">Restart the Quiz!</button>                       
                                </section>
                                `
...
/*** Restarts the Quiz *****/
    ...
    $('body').on('click', '#restartButton', function (e) {
        ...
        // DOESN'T WORK RIGHT - NEEDS TO BE FIXED - 
        // GLOBAL VARIABLES DON'T UPDATE CORRECTLY 
